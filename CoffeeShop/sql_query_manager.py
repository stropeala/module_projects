...
ORDER_MARIUSICA = ("FRIPTURA", "3", "MARIUSICA BOSSULICA", "2025-06-07 20:45", "TEST")

ORDERS_GET_QTY_SUM = "client_id, SUM(qty)"
ORDERS_GET_QTY_SUM_GROUPED = "GROUP by client_id"

MENU_ESPRESSO_PRICE = "name='Espresso'"
MENU_ESPRESSO_NEW_PRICE = "price='12,99'"

ORDER_MARIUSICA_DELETE = "client_id='MARIUSICA BOSSULICA'"
